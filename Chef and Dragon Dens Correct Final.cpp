...
ll n, q;
ll h[N], a[N], m_r[N], m_l[N], indLO[N], indLC[N], indRO[N], indRC[N], vis[N];
...
void solve() {
	...
	// fi (0, n + 1) cout << i << " --> " << TL[i] << "\n";
	// fi (0, n + 1) cout << i << " --> " << TR[i] << "///\n";
	...
	cout << TRO << "\n";
	cout << TRC << "\n";
	fi (0, n) cout << indLO[i] << " "; cout << "\n";
	fi (0, n) cout << indLC[i] << " "; cout << "\n";
	fi (0, n) cout << indRO[i] << " "; cout << "\n";
	fi (0, n) cout << indRC[i] << " "; cout << "\n";
